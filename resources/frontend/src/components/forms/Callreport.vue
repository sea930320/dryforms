            ...
            <b-row>
                ...
                <b-col class="text-left">
                    ...
                    <div v-for="item in inputGroup3" :key="item.label">
                        <label>{{ item.label }}</label>
                        <b-form-checkbox v-model="sameJobAddress" v-if="item.model == 'address'" id="copy_address">Same
                            as job address
                        </b-form-checkbox>
                        <b-form-checkbox v-model="sameContactName" v-if="item.model == 'ownerName'" id="copy_name">Same
                            as contact name
                        </b-form-checkbox>
