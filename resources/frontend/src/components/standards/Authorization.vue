<template>
  <div class="card text-left">
    ...
    <div class="card-body">
      ...
      <vue-editor id="bodyEditor" v-model="bodyText"></vue-editor>
      <div class="mt-3">
...
<script type="text/babel">
  ...
  export default {
    ...
    data () {
      return {
        sideMenuName: 'Work Authorization',
        formTitle: 'Work Authorization & Direct Payment Request',
        addNotes: false,
        addFooter: false,
        addSignature: false,
        bodyText: '<h1>some content</h1>',
